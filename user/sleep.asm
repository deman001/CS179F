...
int main(int argc, char *argv[]) {
   ...
   a:	02a7d063          	bge	a5,a0,2a <main+0x2a>
        printf("Need an argument. Usage: sleep [num]\n");
        exit(0);
    }
...
free(void *ap)
{
 ...
 676:	1ae7b783          	ld	a5,430(a5) # 820 <freep>
 ...
 6a4:	00e6ea63          	bltu	a3,a4,6b8 <free+0x50>
{
 ...
 6e6:	12f73f23          	sd	a5,318(a4) # 820 <freep>
}
 6ea:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 718:	10c53503          	ld	a0,268(a0) # 820 <freep>
 ...
 740:	0e490913          	addi	s2,s2,228 # 820 <freep>
  if(p == (char*)-1)
 744:	5afd                	li	s5,-1
 746:	a895                	j	7ba <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 748:	00000797          	auipc	a5,0x0
 74c:	0e078793          	addi	a5,a5,224 # 828 <base>
 750:	00000717          	auipc	a4,0x0
 754:	0cf73823          	sd	a5,208(a4) # 820 <freep>
 758:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a8:	ec4080e7          	jalr	-316(ra) # 668 <free>
  return freep;
 ...
 7ca:	b74080e7          	jalr	-1164(ra) # 33a <sbrk>
  if(p == (char*)-1)
